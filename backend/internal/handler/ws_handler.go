...
func (h *WSHandler) HandleWS(c *gin.Context) {
	...
	client := &ws.Client{
		...
		Hub:          h.hub,
		ChatHandler:  ws.NewChatSendHandler(h.messageSendService, h.userService),
		AckHandler:   ws.NewMessageAckHandler(h.messageReceiptService, h.conversationSyncService, h.userService),
	}
