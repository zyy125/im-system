  ...
  return (
    <div className="sidebar-list">
      {conversations.map((conversation) => (
        ...
        >
          <div className="sidebar-list__avatar">
            {conversation.peer?.username?.slice(0, 1) || conversation.name.slice(0, 1)}
          </div>
          <div className="sidebar-list__meta">
            ...
            <div className="sidebar-list__subtitle-row">
              ...
              {conversation.unreadCount > 0 ? (
                <span className="sidebar-list__badge">{conversation.unreadCount}</span>
              ) : null}
            </div>
          </div>
        </button>
